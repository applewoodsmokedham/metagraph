...
exports.RunestoneCanvasVisualizer = void 0;
const canvas_1 = require("canvas");
/**
 * Class to visualize runestone data using Canvas
 */
class RunestoneCanvasVisualizer {
    /**
     ...
     */
    static visualizeSingle(runestoneData) {
        const width = 800;
        const height = 600;
     ...
     * @returns Buffer containing the PNG image
     */
    static visualizeSummary(runestones) {
        const width = 800;
        const height = 600;
        const canvas = (0, canvas_1.createCanvas)(width, height);
        const ctx = canvas.getContext('2d');
...
exports.RunestoneCanvasVisualizer = RunestoneCanvasVisualizer;
//# sourceMappingURL=canvas-visualizer.js.map